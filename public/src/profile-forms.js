...
import { clearFormErrors, getPendingPhotoFile, markFieldInvalid, setButtonBusy, setPendingPhotoFile, showFormStatus, updateProfileRatingDisplay } from './profile-ui.js';
...
export function saveProfile() {
  ...
  var photoFile = getPendingPhotoFile();
  var photoPromise = photoFile ? API.uploadPhoto(photoFile).then(function () { setPendingPhotoFile(null); }) : Promise.resolve();
